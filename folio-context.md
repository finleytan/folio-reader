...
Single-file HTML PWA (~3,857 lines). Audiobook/ebook reader with synced word-level highlighting.
...
**Approximate line ranges (index.html):** CSS `16–511` · HTML `513–914` · JS `915–3855`
